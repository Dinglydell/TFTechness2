...
public class Material {
	...
	private Material(String name, int tier, boolean isTFC) {
		this.isTFC = isTFC;
	...
	public Material(String name, int tier, Alloy.EnumTier alloyTier, boolean isTFC) {
	...
	public void addMachineRecipes(){
		//sheet
		MetalPressRecipe.addRecipe(new ItemStack(sheet, 1), new ItemStack(ingot, 2), TFTMeta.ieMoldPlate, 2400);
		MetalPressRecipe.addRecipe(new ItemStack(sheet, 1), "ingotDouble" + metal.name, TFTMeta.ieMoldPlate, 2400);
		
		//sheet2x
		MetalPressRecipe.addRecipe(new ItemStack(sheet2x, 1), new ItemStack(ingot2x, 2), TFTMeta.ieMoldPlate, 2400);
		MetalPressRecipe.addRecipe(new ItemStack(sheet2x, 1), new ItemStack(ingot, 4), TFTMeta.ieMoldPlate, 4800);
	...
	public void addAnvilRecipes(){
		...
		if(!isTFC){
			...
			manager.addWeldRecipe(new AnvilRecipe(new ItemStack(ingot),
					new ItemStack(ingot), AnvilReq.getReqFromInt(tier - 1), new ItemStack(ingot2x, 1)));
